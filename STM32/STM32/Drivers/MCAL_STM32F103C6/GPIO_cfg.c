...
GPIO_Pinconfig_t PINs_Config[] ={
		...
		{GPIO_PIN2, GPIOB, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10M},
		{GPIO_PIN3, GPIOB, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10M},

		{GPIO_PIN4, GPIOB, GPIO_MODE_INPUT_FLOAT, GPIO_SPEED_RSP},
		{GPIO_PIN5, GPIOB, GPIO_MODE_INPUT_FLOAT, GPIO_SPEED_RSP},
		{GPIO_PIN6, GPIOB, GPIO_MODE_INPUT_FLOAT, GPIO_SPEED_RSP},
		{GPIO_PIN7, GPIOB, GPIO_MODE_INPUT_FLOAT, GPIO_SPEED_RSP},
};
